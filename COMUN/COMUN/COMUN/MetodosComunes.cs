...
namespace COMUN
{
    static public class MetodosComunes
    {
        ...
        /* calcular edad 
  int age = DateTime.Now.Year - fechanacimiento.Value.Year - (DateTime.Now.DayOfYear < fechanacimiento.Value.DayOfYear ? 1 : 0);
*/
        ...
        #region LOG
        /* LOG
                        string ArchivoPrincipal = @"C:\Users\PC\source\repos\Ejercicio Integrador PI 2021\Registros";
                        string ArchivoEspecifico = @"C:\Users\PC\source\repos\Ejercicio Integrador PI 2021\Registros\Registros.txt";

                        var direccion = new DirectoryInfo(ArchivoPrincipal);
                        if (!direccion.Exists)
                        {
                            Directory.CreateDirectory(ArchivoPrincipal);
                        }
                        StreamWriter sw;
                        if (File.Exists(ArchivoEspecifico))
                        {
                            sw = File.AppendText(ArchivoEspecifico);
                        }
                        else
                        {
                            sw = File.CreateText(ArchivoEspecifico);
                        }
                        sw.WriteLine("----------AVISO----------");
                        sw.WriteLine("Registro creado en: " + DateTime.Now);
                        sw.WriteLine("");
                        sw.WriteLine("CUIT: " + cuit.Text);
                        sw.WriteLine("Edad: " + edad.Text);
                        sw.WriteLine("Cantidad de personas con las que suele viajar: " + cantidadpersonas.Text);
                        sw.WriteLine("");
                        sw.WriteLine("Lugares preferidos:");
                        if (montaña.Checked == true)
                        {
                            sw.WriteLine("Montaña");
                        }
                        if (otros.Checked == true)
                        {
                            sw.WriteLine("" + txtOtros.Text);
                        }
                        sw.WriteLine("");
                        sw.WriteLine("Estación Preferida:");
                        if (verano.Checked == true)
                        {
                            sw.WriteLine("Verano");
                        }
                        sw.WriteLine("");
                        sw.WriteLine("Tipo Hospedaje: " + hospedajes.SelectedItem);
                        sw.WriteLine("-------------------------");
                        sw.WriteLine("");
                        sw.Close();*/
        /*
                int indice = listboxValores.SelectedIndex;
                listboxValores.Items.RemoveAt(indice);
        ....................................................
        if (listboxValores.SelectedItem == null)
            {
                MessageBox.Show("Seleccione un valor desea eliminar ", "error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        */
        static public void RegistrarLog(string mensaje, string especificacion, string ruta)
        {
            ...
            string ARCHIVOLOG = "ArchivoLog" + DateTime.Now + ".txt";
        ...
        public static void EnviarMail(StringBuilder CuerpoMail, string TIPO)
        {
            try
            {
                ...
                server.Credentials = new System.Net.NetworkCredential("yuehuangmatias@gmail.com", "ContrasenaDeMail");
                ...
                switch (TIPO)
                {
                    case "ERROR": mailTo = "yue1786812727@gmail.com"; mailTo2 = "yue1786812727@gmail.com"; break;// a quien se lo envia. el para
                    case "EXITO": mailTo = "yue1786812727@gmail.com"; mailTo2 = "yue1786812727@gmail.com"; break;// a quien se lo envia. el para
                    case "ADVERTENCIA": mailTo = "yue1786812727@gmail.com"; mailTo2 = "yue1786812727@gmail.com"; break;// a quien se lo envia. el para
                    default:
                        break;
                }
                ...
                correoElectronico.From = new MailAddress("yuehuangmatias@gmail.com.ar", "pp020115");
        ...
        /* MAIL
                ...
                msg.To.Add("yue1786812727@gmail.com");
                msg.Subject = "Aviso";
                msg.SubjectEncoding = Encoding.UTF8;
                msg.Body = "Se ha realizdo  un nuevo registro con la siguiente información: \nNombre y Apellido: "+nombre.Text+" "+apellido.Text+" \nCUIT: "+cuit.Text;
                msg.BodyEncoding = Encoding.UTF8;
                msg.IsBodyHtml = true;

                msg.From = new MailAddress("yue1786812727@gmail.com");
                SmtpClient cliente = new SmtpClient();
                cliente.Credentials = new System.Net.NetworkCredential("yue1786812727@gmail.com", "CONTRASENA"); 
                cliente.Port = 587;
                ...
                {
                    MessageBox.Show("Ha ocurrido un error al enviar el mail, verifique los datos y vuelva a intentarlo", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
*/
